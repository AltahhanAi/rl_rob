'''
    This simple class allows us to deal with an environment with a continuous state, unlike the Grid class
    which is a discrete state environment. To deal with it, you will need to discretise it. 
...
# ============================ Mountain Car Class ==================================================
''''
    Mountain Car using the Gym environment or our own bespoke-made mountain car environment
'''
...
MountainCarGym = Mountain(MountainCarEnv)
# ===========================tile coding================================================================
