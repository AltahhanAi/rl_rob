'''
    This is a library for handling the Grid world with vectorised state representation.
    ...
    Vectorised Grid class is to be used with linear function approximation algorithms
'''
...
# =========================== useful vec grid env for prediction and control =========================
